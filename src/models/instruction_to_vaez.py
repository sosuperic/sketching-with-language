...
class HParams():
    def __init__(self):
        ...
        self.dataset = 'ndjson'
        self.categories = 'pig'
        self.max_per_category = 65000
        self.prob_threshold = 0.0  # prune trees
        self.batch_size = 64

        self.lr = 0.0001
        self.lr_decay = 1.0  # no decay
        self.min_lr = 0.00001
        self.grad_clip = 1.0
        self.max_epochs = 100
...
class InstructionToVAEzModel(TrainNN):
    ...
    def __init__(self, hp, save_dir):
        ...
        self.models = [self.text_embedding, self.category_embedding, self.enc, self.fc_enc_to_zdim]
    ...
    def one_forward_pass(self, batch):
        ...
        elif self.hp.loss == 'triplet':
            vae_zs_shuffled = vae_zs[torch.randperm(bsz),:]  # [bsz, z_dim]
            loss = F.triplet_margin_loss(instruction_embs, vae_zs, vae_zs_shuffled)
