...
VAEZ_PATH = Path('runs/sketchrnn/Mar22_2020/vae_all70k/batch_size_256-categories_all-dataset_ndjson-dec_dim_2048-dropout_0.1-enc_dim_512-enc_num_layers_1-lr_0.0001-max_per_category_70000-model_type_vae-rec_dropout_0.1-use_categories_dec_True-use_layer_norm_True/inference_z/')